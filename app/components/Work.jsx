    ...
    <div id='work' className='w-full px-[20%] py-6 scroll-mt-20'>
       ...
       <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-15 my-12'>
        {workData.map((project, index) => (
          <div 
            key={index} 
            className='relative aspect-square bg-cover bg-center rounded-lg cursor-pointer overflow-hidden group' // Added the 'group' class here
          ...
          >
            ...
            >
             ...
             {/* Use ToolList component here and pass the tools */}
